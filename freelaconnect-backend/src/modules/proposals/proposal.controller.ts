...
export class ProposalController {
  ...
  @ApiCreatedResponse({ description: 'Proposta enviada com sucesso.', type: ProposalResponseDto })
  ...
  @ApiOkResponse({ description: 'Propostas retornadas com sucesso.', type: [ProposalResponseDto] })
  ...
  @ApiOkResponse({ description: 'Proposta encontrada.', type: ProposalResponseDto })
