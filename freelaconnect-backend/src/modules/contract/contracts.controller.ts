...
export class ContractsController {
    ...
    @ApiOkResponse({ description: 'Contrato confirmado com sucesso.', type: ConfirmContractResponseDto })
    ...
    @ApiCreatedResponse({ description: 'Contrato criado com sucesso.', type: ContractResponseDto })
    ...
    @ApiOkResponse({ description: 'Contratos retornados com sucesso.', type: PaginatedContractResponseDto })
    ...
    @ApiParam({ name: 'id', example: 1 })
    @ApiOkResponse({ description: 'Contrato atualizado com sucesso.', type: ContractResponseDto })
    @ApiNotFoundResponse({ description: 'Contrato nao encontrado.' })
    @HttpCode(HttpStatus.OK)
    ...
    @ApiParam({ name: 'id', example: 1 })
    @ApiOkResponse({ description: 'Contrato substituido com sucesso.', type: ContractResponseDto })
    @ApiNotFoundResponse({ description: 'Contrato nao encontrado.' })
    @HttpCode(HttpStatus.OK)
    ...
    @ApiParam({ name: 'id', example: 1 })
    @ApiOkResponse({ description: 'Contrato encontrado.', type: ContractResponseDto })
    @ApiNotFoundResponse({ description: 'Contrato nao encontrado.' })
    @HttpCode(HttpStatus.OK)
