...
export interface ContractRepository {
    ...
    findAll(page?: number, limit?: number): Promise<{ data: ContractEntity[], total: number }>;
    save(contract: ContractEntity): Promise<ContractEntity>;
    update(contractId: number, contract: Partial<ContractEntity>): Promise<ContractEntity | null>;
