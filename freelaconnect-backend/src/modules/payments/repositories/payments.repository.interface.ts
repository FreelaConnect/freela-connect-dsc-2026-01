...
export interface PaymentsRepository {
    ...
    findAll(page?: number, limit?: number): Promise<{ data: PaymentEntity[], total: number }>;
    save(payment: PaymentEntity): Promise<PaymentEntity>;
    update(paymentId: string, payment: Partial<PaymentEntity>): Promise<PaymentEntity | null>;
